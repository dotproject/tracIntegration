...
foreach($tracpr->fetchEnvironments() as $env){
	...
	.'<button id="delete'.$env['dtvalue'].'" name="delete"'
	.'value="'.$env['dtvalue'].'" style="background: transparent; border:0;" title="Click to delete this environment">'
